/**
 * Incluye el CSS del paquete en la página si no se ha incluido previamente.
 */
document.addEventListener("DOMContentLoaded", function () {
  if (!document.querySelector('link[href*="nextjs-toast-notify.css"]')) {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href =
      "https://cdn.jsdelivr.net/npm/nextjs-toast-notify@1.33.0/dist/styles/nextjs-toast-notify.css";
