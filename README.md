...
<html lang="es">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/nextjs-toast-notify@1.23.0/dist/nextjs-toast-notify.css"
    />
  </head>
  <body>
    ...
    <script type="module">
      import { toast } from "https://unpkg.com/nextjs-toast-notify@1.23.0/dist/index.js";
